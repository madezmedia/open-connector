...
const hostedVariantSchema = s.object(
  "One hosted image variant returned by ImgBB.",
  {
...
const uploadImageOutputSchema = s.object(
  "The output payload for uploading an image to ImgBB.",
  {
    upload: s.object(
